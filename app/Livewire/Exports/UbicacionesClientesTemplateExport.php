...
class UbicacionesClientesTemplateExport implements FromCollection, WithMapping, WithHeadings, WithTitle, WithColumnWidths, WithEvents
{
    ...
    {
        $rows = DB::select('EXEC dbo.sp_ubicaciones_clientes_exportar ?', [$this->cuit]);
