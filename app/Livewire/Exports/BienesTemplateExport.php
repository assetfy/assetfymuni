...
class BienesTemplateExport implements FromCollection, WithMapping, WithHeadings, WithTitle, WithColumnWidths, WithEvents
{
    ...
    private array $headings = [
        ...
        'Estado General','Estado Alta','Ubicación','Depende de', 'Nivel Organización', 'Atributos',
    ...
    {
        $rows = DB::select('EXEC dbo.sp_bienes_exportar ?', [$this->cuit]);
