...
class OrdenesTrabajoTemplateExport implements FromCollection, WithMapping, WithHeadings, WithTitle, WithColumnWidths, WithEvents
{
    ...
    {
        $rows = DB::select('EXEC dbo.sp_ordenes_trabajo_exportar ?', [$this->cuit]);
