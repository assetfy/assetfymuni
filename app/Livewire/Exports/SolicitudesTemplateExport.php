...
class SolicitudesTemplateExport implements FromCollection, WithMapping, WithHeadings, WithTitle, WithColumnWidths, WithEvents
{
    ...
    {
        $rows = DB::select('EXEC dbo.sp_solicitudes_exportar ?', [$this->cuit]);
