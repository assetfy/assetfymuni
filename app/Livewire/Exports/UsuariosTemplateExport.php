...
class UsuariosTemplateExport implements FromCollection, WithMapping, WithHeadings, WithTitle, WithColumnWidths, WithEvents
{
    public function __construct(private string $cuit) {}

     // 1) Encabezados VISIBLES (los que espera tu import)
    private array $headings = [
        'Nombre y Apellido', 'Email','CUIL','Legajo','CUIT Empresa','Tipo Usuario', 'NumContrato', 'Supervisor', 'Depende de', 'Nivel Organización'
    ];
    ...
    {
        $rows = DB::select('EXEC dbo.sp_usuarios_exportar ?', [$this->cuit]);
    ...
    {
        return [
            'A'=>28,'B'=>28,'C'=>18,'D'=>20,'E'=>22,'F'=>16,'G'=>18,
            'H'=>12,'I'=>20,'J'=>28
        ];
    }
