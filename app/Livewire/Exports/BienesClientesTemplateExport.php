...
class BienesClientesTemplateExport implements FromCollection, WithMapping, WithHeadings, WithTitle, WithColumnWidths, WithEvents
{
    public function __construct(private string $cuit) {}

     // 1) Encabezados VISIBLES (los que espera tu import)
    private array $headings = [
        'ID Externo','Nombre','Tipo','Categoria','Subcategoria',
        'Estado General','Estado Alta','Ubicación','Depende de','Atributos',
        'Usuario Titular','Responsable Inventario','Condicion','Marca','Modelo','Identificador',
        'CUIT Propietario'
    ];

    // 2) Claves que devuelve el SP (tal cual vienen de DB)
    private array $dbCols = [
        'ID_externo','Nombre','Tipo','Categoria','Subcategoria',
        'Estado General','Estado alta','Ubicación','Depende de','Atributos',
        'Usuario Titular','Responsable Inventario','Condicion','Marca','Modelo','Identificador',
        'CUIT Propietario'
    ];
    ...
    {
        $rows = DB::select('EXEC dbo.sp_bienes_clientes_exportar ?', [$this->cuit]);
    ...
    {
        return [
            'A'=>18,'B'=>28,'C'=>18,'D'=>20,'E'=>22,'F'=>16,'G'=>18,'H'=>22,
            'I'=>20,'J'=>32,'K'=>22,'L'=>26,'M'=>18,'N'=>18,'O'=>18,'P'=>20,
            'Q'=>22,
        ];
    }
