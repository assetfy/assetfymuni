...
use App\Exports\HistorialServiciosExport;
...
class SolicitudServicios extends LivewireTable
{
    ...
    public $panel_usuario, $isDisabled, $gestor;
    ...
    protected function query(): Builder
    {
        ...
        $query = \App\Models\SolicitudesServiciosModel::whereIn('act.solicitudes_servicios.id_activo', $activosIds)
        ...
        $this->gestor = \App\Models\AsignacionesRolesModel::where('usuario_empresa', Auth::user()->id)
    ...
    protected function columns(): array
    {
        $columns = [
            Column::make(__('Reseña'), function (Model $model): string {
                ...
                class="bg-gray-400 hover:bg-gray-800 text-black font-bold py-2 px-4 rounded border border-black h-12" 
        ...
        return [
            Action::make('Exportar Historial', 'export_selected', function (Enumerable $models) {
                ...
                return Excel::download(
                    new HistorialServiciosExport($models),
                    'historial_servicios.xlsx'
                );
            }),
        ];
    }
