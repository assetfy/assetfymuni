...
class UsuariosSinPermisos extends LivewireTable
{
    ...
    protected $listeners = ['updateEstadoUsuario', 'updateTipoUsuario', 'updateRepresentante'];
    ...
    protected function query(): Builder
    {
        ...
        return UsuariosEmpresasModel::with('permisos') // relación con User
            ->where('cuit', $cuit)
