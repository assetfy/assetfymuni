<div class="p-2">
    <h1 class="text-3xl font-bold mb-4">Colección de Activos</h1>
    <div>
                            ...
                            <div class="card-container relative h-80 transform-style-preserve-3d transition-transform duration-500"
                                ...
                                <div class="card-front absolute w-full h-full backface-hidden shadow-lg">
                                    <div class="bg-white rounded-lg p-4 relative h-full flex flex-col justify-between">
                                        <div class="absolute top-2 right-2 flex items-center text-sm text-gray-400 ajax-link tooltip-item"
                                            wire:click="openEditarActivo({{ $activo }})"
                                            onclick="event.stopPropagation();" data-tippy-content="Editar activo">
                                            <video width="40" height="40" preload="none"
                                                style="background: transparent  
                                        url('https://cdn-icons-png.flaticon.com/512/12747/12747627.png') 50% 50% / fit no-repeat;"
                                                autoplay="autoplay" loop="true" muted="muted" playsinline="">
                                                <source src="https://cdn-icons-mp4.flaticon.com/512/12747/12747627.mp4"
                                                    type="video/mp4">
                                            </video>
                                        </div>
                                        <div class="text-body-secondary">
                                            <div class="mx-auto w-36 ajax-link tooltip-item"
                                                data-tippy-content="Escanea el código QR">
                                        ...
                                        <div>
                                            ...
                                            @endif
                                            @if ($activo->tipo)
                                                <div class="absolute bottom-2 right-2 flex items-center text-sm text-gray-400 ajax-link tooltip-item"
                                                    data-tippy-content="Click para más detalles">
                                ...
                                <div
                                    class="card-back absolute w-full h-full bg-white rounded-lg p-4 transform rotate-y-180 backface-hidden text-black">
