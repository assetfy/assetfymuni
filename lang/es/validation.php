...
return [
    ...
    */
    ...
    | especificar una línea de lenguaje personalizada específica para una regla de atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se utilizan para intercambiar el marcador de posición de
    | nuestros atributos con algo más amigable para el lector, como "Dirección de correo electrónico"
    | en lugar de "email". Esto simplemente nos ayuda a hacer nuestros mensajes más expresivos.
    |
    */
